...
# no relationship the linear regression can not be used to predict anything.
...
# Note: The result -0.76 shows that there is a relationship, not perfect, but it indicates that we could use linear regression
