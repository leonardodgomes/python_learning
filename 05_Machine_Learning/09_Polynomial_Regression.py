...
# Polynomial regression, like linear regression, uses the relationship between the variables x and y to find the best
...
#  Example: How well does my data fit in a polynomial regression?
...
# Example: These values for the x- and y-axis should result in a very bad fit for polynomial regression:
...
# Example: You should get a very low r-squared value.
