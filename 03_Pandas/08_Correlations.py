...
# Example: Show the relationship between the columns: df.corr()

import pandas as pd

df = pd.read_csv('C:\\Users\\a070127\\Documents\\Leonardo\\Pessoal\\Python\\03_Pandas\\00_Files\\data.csv')

print(df.corr()) #The corr() method ignores "not numeric" columns.
...
#   can predict that the longer you work out, the more calories you burn, and the other way 
#   around: if you burned a lot of calories, you probably had a long work out.
